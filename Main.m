...
Data(11).pID = {'PCi'};
Data(11).Sessions=[ 1 2 3 4 ];
Data(11).Outcomes.Days = [  1 22 29 36 43 50 57 72 ];
Data(11).Outcomes.BDI =  [ 50 23 20 19 20 31 30 38 ];
Data(11).Outcomes.BAI =  [ 39 24 20 17 16 19 19 26 ];
Data(11).Outcomes.EEGDay = [ 1 22 36 72];

Data(12).pID = {'NSt'};
Data(12).Sessions=[ 1 2 3 4 ];
Data(12).Outcomes.Days = [  1 66 74 81 92 99 106 117 ];
Data(12).Outcomes.BDI =  [ 36 10  9  3  6  6   4   2 ];
Data(12).Outcomes.BAI =  [ 20  8  5  4  4  9   4   3 ];
Data(12).Outcomes.EEGDay = [ 43 58 80 117 ];


Data(13).pID = {'BKBr'};
Data(13).Sessions=[ 1 2 3 4 ];
Data(13).Outcomes.Days = [  1 63 70 78 85 92 101 121 ];
Data(13).Outcomes.BDI =  [ 20 19  7 18 18  8   9   8 ];
Data(13).Outcomes.BAI =  [  8  7  4  5  7  1   1   0 ];
Data(13).Outcomes.EEGDay = [ 51 63 84 121 ];


Data(14).pID = {'SCo'};
Data(14).Sessions=[ 1 2 3 4 ];
Data(14).Outcomes.Days = [  1  3 16 27 44 52 70 79 93 ];
Data(14).Outcomes.BDI =  [ 59 58 58 52 50 54 54 42 28 ];
Data(14).Outcomes.BAI =  [ 55 54 47 38 41 37 35 25 18 ];
Data(14).Outcomes.EEGDay = [ 9 14 41 93 ];
